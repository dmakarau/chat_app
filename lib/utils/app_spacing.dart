...
extension AppSpacing on EdgeInsets {
  ...
  static const EdgeInsets extraLarge = EdgeInsets.all(AppConstants.extraLargePadding);
  ...
  static const EdgeInsets cardMargin = EdgeInsets.all(AppConstants.mediumPadding);
  static const EdgeInsets cardPadding = EdgeInsets.all(AppConstants.defaultPadding);
